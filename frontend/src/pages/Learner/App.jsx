      ...
      <div className={`app-wrapper ${isAuthRoute ? 'auth-page' : 'scrollable-content'}`}>
        ...
        <div style={{ 
          ...
          <Routes>
            ...
            <Route path="/learner/quiz/:quizId" element={<PrivateRoute element={<QuizAttempt />} roles={["user"]} />} />
            <Route path="/video-player" element={<PrivateRoute element={<VideoPlayer />} roles={["user"]} />} />
            <Route path="/learner/document/:id" element={<PrivateRoute element={<DocumentViewer />} roles={["user"]} />} />
