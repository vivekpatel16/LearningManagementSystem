...
const { registerUser, getAllUsers, courseStatus, removeUser, updateUser, getLearnerReport, generateLearnerPDF } = require("../controllers/adminController");
...
router.get("/learner-report/:learnerId/pdf",authenticateUser,generateLearnerPDF);
